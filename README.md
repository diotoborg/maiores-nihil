...
* Low-overhead and fast performance (see [benchmarks](https://@diotoborg/maiores-nihil.dev/benchmarks))
...
- Documentation: https://@diotoborg/maiores-nihil.dev/
- Changelog: https://@diotoborg/maiores-nihil.dev/changelog
...
Follow the [documented build instructions](https://@diotoborg/maiores-nihil.dev/contribute#build-from-source) to build Koffi from source.
